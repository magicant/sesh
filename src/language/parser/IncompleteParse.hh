...
#ifndef INCLUDED_language_parser_IncompleteParse_hh
#define INCLUDED_language_parser_IncompleteParse_hh
 ...
 * appended to but not otherwise modified because the parser may not
 * necessarily re-parse the whole new source.)
 *
 ...
 */
class IncompleteParse : public std::logic_error {
...
#endif // #ifndef INCLUDED_language_parser_IncompleteParse_hh
